...
one <-1 
jan2019_nyt <- fromJSON("https://api.nytimes.com/svc/archive/v1/2019/1.json?api-key=B8Swl3B2OdxnBuacJyzDHcc93gVPbi1i", flatten = TRUE) %>%
  data.frame()
feb2019_nyt <- fromJSON("https://api.nytimes.com/svc/archive/v1/2019/2.json?api-key=B8Swl3B2OdxnBuacJyzDHcc93gVPbi1i", flatten = TRUE) %>%
  data.frame()
mar2019_nyt <- fromJSON("https://api.nytimes.com/svc/archive/v1/2019/2.json?api-key=B8Swl3B2OdxnBuacJyzDHcc93gVPbi1i", flatten = TRUE) %>%
  data.frame()
...
jan_2008 <- fromJSON("https://api.nytimes.com/svc/archive/v1/2008/1.json?api-key=B8Swl3B2OdxnBuacJyzDHcc93gVPbi1i", flatten = TRUE) %>%
  data.frame() 
...
nyt_year_scraper <- function(year, start_month, end_month) {
  ...
  for (i in start_month:end_month) {
    month_tbl <- tibble()
    query <- str_glue("https://api.nytimes.com/svc/archive/v1/", year, "/", i, ".json?api-key=B8Swl3B2OdxnBuacJyzDHcc93gVPbi1i", sep = '')
