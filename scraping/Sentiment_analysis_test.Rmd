...
Sanctions <- read_excel("Documents/All things R /CURI /Other data/GSDB_V2 (1)/GSDB_V2.xls")
US_aid <- read_csv("Documents/All things R /CURI /Other data/us_foreign_aid_country.csv")
WSJ_LIWC <- read_csv("Documents/All things R /CURI /WSJ /full years/WSJ_5_LIWC.csv")
write_csv(WSJ_1989_filter, "~/Documents/All things R /CURI /WSJ /full years/WSJ_1989_filter.csv")
```
